...
public class JwtTokenUtil {
     ...
     */
    public boolean validateToken(String token, LingoAceUserBriefInfo userDetails) {
        String username = getUserNameFromToken(token);
        if(username.contains(Constants.USER_PASSWORD_SPLIT)){
            username = username.split(Constants.USER_PASSWORD_SPLIT)[1];
        }
        System.out.print(isTokenExpired(token));
